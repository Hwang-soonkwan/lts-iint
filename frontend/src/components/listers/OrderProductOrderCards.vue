    ...
    <div>
        ...
        >
            <v-row>
                <v-list-item class="d-flex">
                    ...
                    <div class="secondary-text-color" style="margin-left:30px;">제품 주문에 대한 어그리거트</div>
                </v-list-item>
            </v-row>
        </v-card>
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    <OrderProductOrder :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" 
        ...
        <v-row>
            <OrderProductOrder :offline="offline" class="video-card" v-for="(value, index) in values" v-model="values[index]" v-bind:key="index" @delete="remove"/>
        </v-row>
    </div>
</template>
